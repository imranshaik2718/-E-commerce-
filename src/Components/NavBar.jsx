...
function NavBar() {
  return (
    <div>
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
       ...
       <svg version="1.0" className='w-15 h-15' xmlns="http://www.w3.org/2000/svg"
      ...
      <g transform="translate(0.000000,1024.000000) scale(0.100000,-0.100000)"
        ...
        <h1 className=' text-black'>SPYKAR</h1>
        </div>
       <ul className="hidden md:flex space-x-8 text-gray-900 font-medium">
  <li>
    <a href="/footwear" className="hover:opacity-75">Footwear</a>
  </li>
  <li>
    <a href="/backpacks" className="hover:opacity-75">Backpacks</a>
  </li>
  <li>
    <a href="/apparel" className="hover:opacity-75">Apparel</a>
  </li>
  <li>
    <a href="/accessories" className="hover:opacity-75">Accessories</a>
  </li>
  <li>
    <a href="/collections" className="hover:opacity-75">Collections</a>
  </li>
</ul>

        <div className="flex space-x-4">
          <a href="/search" className="hover:opacity-75"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" id="Search--Streamline-Tabler" height="24" width="24">

  <path d="M3 10a7 7 0 1 0 14 0 7 7 0 1 0 -14 0" stroke-width="2"></path>
  <path d="m21 21 -6 -6" stroke-width="2"></path>
</svg></a >
          <a href="/cart" className="hover:opacity-75"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" id="Shopping-Bag-Edit--Streamline-Tabler" height="24" width="24">
  ...
  <path d="M18.42 15.61a2.1 2.1 0 0 1 2.97 2.97L18 22h-3v-3l3.42 -3.39z" stroke-width="2"></path>
          ...
          <a href="/account" className="hover:opacity-75"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" id="User--Streamline-Tabler" height="24" width="24">
